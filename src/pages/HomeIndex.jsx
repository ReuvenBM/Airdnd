...
import { loadHomes, addHome, updateHome, removeHome, addHomeMsg } from '../store/home.actions'
...
export function HomeIndex() {
    ...
    return (
        <main className="home-index">
            <header>
                <h2>Homes</h2>
                {userService.getLoggedinUser() && <button onClick={onAddHome}>Add a Home</button>}
            </header>
