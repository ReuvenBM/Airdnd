    ...
    homes = [
      {
        ...
        amenities: ["WiFi", "Fireplace", "Garden", "Washer", "TV", "Balcony", "Kitchen", "AC"],
        msgs: [],
      ...
      },
      {
        ...
        amenities: ["Refrigerator", "Fire extinguisher"],
        msgs: [],
        unavailableDates: utilService.getRandomBookedDates(10),  
        lastSearchValue: "",
        createdAt: Date.now(),
      },
      {
        ...
        amenities: ["Wine glasses", "Fireplace", "WiFi"],
        msgs: [],
        unavailableDates: utilService.getRandomBookedDates(10),  
        lastSearchValue: "",
        createdAt: Date.now(),
      },
      {
        ...
        amenities: ["WiFi", "Pets allowed", "Nature View"],
        msgs: [],
        unavailableDates: utilService.getRandomBookedDates(10),  
        lastSearchValue: "",
        createdAt: Date.now(),
      },
      {
        ...
        amenities: ["Fireplace", "Free parking", "WiFi"],
        msgs: [],
        unavailableDates: utilService.getRandomBookedDates(10),  
        lastSearchValue: "",
        createdAt: Date.now(),
      ...
      },
      {
        ...
        amenities: ["WiFi", "Coffee", "Hot water"],
        msgs: [],
        unavailableDates: utilService.getRandomBookedDates(10),  
        lastSearchValue: "",
        createdAt: Date.now(),
      },
      {
        ...
        amenities: ["Fire extinguisher", "Bikes", "WiFi"],
        msgs: [],
        unavailableDates: utilService.getRandomBookedDates(10),  
        lastSearchValue: "",
        createdAt: Date.now(),
      },
      {
        ...
        amenities: ["WiFi", "Washer", "Self check-in"],
        msgs: [],
        unavailableDates: utilService.getRandomBookedDates(10),  
        lastSearchValue: "",
        createdAt: Date.now(),
      ...
      },
      {
        ...
        amenities: ["WiFi", "Smoke Alarm", "Washer"],
        msgs: [],
        unavailableDates: utilService.getRandomBookedDates(10),  
        lastSearchValue: "",
        createdAt: Date.now(),
      ...
      },
      {
        ...
        amenities: ["WiFi", "Pets allowed", "AC"],
        msgs: [],
        unavailableDates: utilService.getRandomBookedDates(10),  
        lastSearchValue: "",
        createdAt: Date.now(),
      },
      {
        ...
        amenities: ["WiFi", "Hammock", "Self check-in"],
        msgs: [],
        unavailableDates: utilService.getRandomBookedDates(10),  
        lastSearchValue: "",
        createdAt: Date.now(),
      },
      {
        ...
        amenities: ["WiFi", "Workspace", "Coffee"],
        msgs: [],
        unavailableDates: utilService.getRandomBookedDates(10),  
        lastSearchValue: "",
        createdAt: Date.now(),
      ...
      },
      {
        ...
        amenities: ["WiFi", "Toaster", "Hair dryer","Bathtub"],
        msgs: [],
        unavailableDates: utilService.getRandomBookedDates(10),  
        lastSearchValue: "",
        createdAt: Date.now(),
      ...
      },
      {
        ...
        amenities: ["WiFi", "Ceiling fan", "Self check-in"],
        msgs: [],
        unavailableDates: utilService.getRandomBookedDates(10),  
        lastSearchValue: "",
        createdAt: Date.now(),
      },
      {
        ...
        amenities: ["WiFi", "Iron", "Balcony","Bathtub"],
        msgs: [],
        unavailableDates: utilService.getRandomBookedDates(10),  
        lastSearchValue: "",
        createdAt: Date.now(),
      },
      {
        ...
        amenities: ["AC", "WiFi", "Exercise equipment"],
        msgs: [],
        unavailableDates: utilService.getRandomBookedDates(10),  
        lastSearchValue: "",
        createdAt: Date.now(),
      },
      {
        ...
        amenities: ["WiFi", "TV", "Self check-in","Bathtub"],
        msgs: [],
        unavailableDates: utilService.getRandomBookedDates(10),  
        lastSearchValue: "",
        createdAt: Date.now(),
      },
      {
        ...
        amenities: ["Bathtub", "WiFi", "Pets allowed"],
        msgs: [],
        unavailableDates: utilService.getRandomBookedDates(10),  
        lastSearchValue: "",
        createdAt: Date.now(),
      },
      {
        ...
        amenities: ["WiFi", "Mountain View", "AC","Bathtub"],
        msgs: [],
        unavailableDates: utilService.getRandomBookedDates(10),  
        lastSearchValue: "",
        createdAt: Date.now(),
