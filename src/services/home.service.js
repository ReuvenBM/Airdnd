  ...
  if (!homes || !homes.length) {
    homes = [
...

      {
        ...
        description: "דירה מודרנית עם נוף לאקרופוליס",
        price: 520,
        capacity: 4,
        rooms: 3,
        beds: 2,
      ...
      {
        _id: utilService.makeId(),
        title: "Plaka Historic Studio",
        description: "סטודיו אותנטי בלב פלאקה",
        price: 410,
        capacity: 2,
        rooms: 1,
        beds: 1,
        ...
        location: {
          country: "Greece",
          city: "Athens",
          address: "Adrianou St 102, Athens",
          lat: 37.9721,
          lng: 23.7308,
        },
      ...
      {
        _id: utilService.makeId(),
        title: "Kolonaki Designer Loft",
        description: "לופט מעוצב בשכונת קולונאקי היוקרתית",
        price: 650,
        capacity: 3,
        rooms: 2,
        beds: 2,
        ...
        location: {
          country: "Greece",
          city: "Athens",
          address: "Kapsali 5, Kolonaki, Athens",
          lat: 37.9784,
          lng: 23.7438,
        },
      ...
      },
      {
        ...
        description: "וילה עם גינה פרטית בקיפיסיה",
        price: 800,
        capacity: 6,
        rooms: 4,
        beds: 4,
        ...
        location: {
          country: "Greece",
          city: "Athens",
          address: "Kifisias Ave 278, Kifisia, Athens",
          lat: 38.0714,
          lng: 23.8081,
        },
      ...
      {
        _id: utilService.makeId(),
        title: "Penthouse with Parthenon View",
        description: "פנטהאוז יוקרתי עם נוף לפרתנון",
        price: 950,
        capacity: 4,
        rooms: 3,
        beds: 2,
      ...
      },
      {
        ...
        description: "דירה בוהמיינית בשכונת אקסרכיה היצירתית",
        price: 470,
        capacity: 3,
        rooms: 2,
        beds: 2,
        ...
        location: {
          country: "Greece",
          city: "Athens",
          address: "Valtetsiou 27, Exarchia, Athens",
          lat: 37.9846,
          lng: 23.7329,
        },
      ...
      {
        _id: utilService.makeId(),
        title: "Neoclassical Mansion Room",
        description: "חדר בבית נאו-קלאסי קרוב למרכז",
        price: 380,
        capacity: 2,
        rooms: 1,
        beds: 1,
      ...
      {
        _id: utilService.makeId(),
        title: "Modern Flat in Gazi",
        description: "דירה מודרנית ליד חיי הלילה של גזי",
        price: 490,
        capacity: 2,
        rooms: 2,
        beds: 1,
        ...
        location: {
          country: "Greece",
          city: "Athens",
          address: "Persefonis 21, Gazi, Athens",
          lat: 37.9783,
          lng: 23.7103,
        },
      ...
      {
        _id: utilService.makeId(),
        title: "Athens Riviera Retreat",
        description: "בית נופש ליד חוף הים באתונה ריביירה",
        price: 790,
        capacity: 5,
        rooms: 3,
        beds: 3,
        ...
        location: {
          country: "Greece",
          city: "Athens",
          address: "Poseidonos Ave 72, Glyfada, Athens",
          lat: 37.8597,
          lng: 23.7549,
        },
      ...
      {
        _id: utilService.makeId(),
        title: "Lycabettus Hill Hideaway",
        description: "דירה שקטה עם נוף מגבעת ליקבטוס",
        price: 560,
        capacity: 3,
        rooms: 2,
        beds: 2,
